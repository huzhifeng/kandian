...
var categoryCmd = {
    ...
    "photo":{"tags": {"$in":["看客","独家图集","图粹","盘点","年度","一周外媒动物图片精选","图话"]}},
    "beauty":{"tags": {"$in":["搜狐美女","清纯美女","美媛馆","私の写真","天天诱惑·美女","美女·写真·艺术"]}},
    "manhua":{"tags": {"$in":["新闻漫画","变态辣椒","张小盒漫画","蔡志忠漫画"]}},
    "junshi":{"tags": {"$in":["军情观察","军事控","军情茶馆","讲武堂","军魂100"]}},
    "wenshi":{"tags": {"$in":["历史七日谈","读写客","微历史","史说新语","史林拍案"]}},
    "yule":{"tags": {"$in":["娱乐BigBang","尖峰娱论","明星皆为微博狂","星大片","谁八卦啊你八卦","百部穿影"]}},
    "fashion":{"tags": {"$in":["穿衣奇葩货","每日时髦不NG","一周穿衣红榜","星妆容红黑榜"]}},
    "film":{"tags": {"$in":["百部穿影"]}},
    "video":{"tags": {"$in":["新闻晚8点", '夜夜谈', '所谓娱乐']}},
    "joke":{"tags": {"$in":["视频.搞笑","冷笑话精选","微博搞笑","我们爱讲冷笑话"]}},
    "life":{"tags": {"$in":["易百科","壹读百科","健康养生","达人极品晒","十万个护肤冷知识","女人必知","女人必备"]}},
