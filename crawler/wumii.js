...
var meizituSubscribes = [
  ...
  //{tname:'赤裸美体',   id:'DZT9477x', tags:[]},
  //{tname:'喷血酥胸',   id:'4Q4VCwNc', tags:[]},
  //{tname:'细腰美腿',   id:'k4FzxUiV', tags:[]},
  //{tname:'性感迷人',   id:'k6b4gfix', tags:[]},
  //{tname:'文艺小清新', id:'beWc1Oxz', tags:[]},
  //{tname:'可爱萌妹子', id:'GthH6PBu', tags:[]},
];
  ...
  request(req, function (err, res, body) {
    ...
    if(entry.crawlFlag) {
      if((newsList.length > 0) && (json.readerModule.nextPageMark != -1)) {
        ...
        console.log("hzfdbg file[" + __filename + "]" + " crawlerSubscribe():["+entry.tname+"] next page="+entry.url);
        setTimeout(function() {
...
var wumiiCrawler = function() {
  ...
  setTimeout(wumiiCrawler, 11000 * 60 * 60);
}
