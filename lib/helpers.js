...
exports.miniImg = function (link) {
  return link ? link : '/img/nopic.gif';
};
...
exports.tags2sitemap = function (type) {
  var html = '';
  var neteaseTags = require('../crawler/netease').subscriptions
  var sohuTags = require('../crawler/sohu').subscriptions
  var ifengTags = require('../crawler/ifeng').subscriptions
  var sinaTags = require('../crawler/sina').subscriptions
  var qqTags = require('../crawler/qq').subscriptions
