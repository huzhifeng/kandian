...
exports.genJwPlayerEmbedCode = function (id, file, image) {
  return util.format('<br/><div id="%s">Loading the player...</div><script type="text/javascript" src="/js/jwplayer/jwplayer.js"></script><script type="text/javascript">jwplayer("%s").setup({file: "%s",image: "%s",autostart: true});</script><br/>', id, id, file, image);
}
